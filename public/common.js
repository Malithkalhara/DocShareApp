...
var FileService = /** @class */ (function () {
    ...
    FileService.prototype.upload = function (data) {
        return this.http.post(this.uri + "/api/file/upload", data);
    };
    FileService.prototype.getUploads = function () {
        return this.http.get(this.uri + "/api/file/allUploads");
    };
