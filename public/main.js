...
var routes = [
    ...
    { path: 'options', loadChildren: './options/options.module#OptionsPageModule', canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]] },
    { path: 'upload', loadChildren: './upload/upload.module#UploadPageModule', canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]] },
    { path: 'download', loadChildren: './download/download.module#DownloadPageModule', canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]] },
    { path: 'userprofile', loadChildren: './userprofile/userprofile.module#UserprofilePageModule', canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]] },
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.userLogin = function (regno, password) {
        var _this = this;
...
module.exports = __webpack_require__(/*! F:\Malith\Ionic\Docshare\Frontend\src\main.ts */"./src/main.ts");
